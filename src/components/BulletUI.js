                    ...
                    <div className="bullet--container">
                        <div className="bullet--info--container">
                            <div className="bullet--info--1">
                                ...
                                {this.state.showStartButton && (
                                    <button
                                        ...
                                        class="bullet--start--button"
                                    >
                                        Start
                                    </button>
                                )}
                                <div className="bullet--item3">
                                    <h1>
                                        Mate in {theme} {moves}
                                    </h1>
                                </div>
                                {this.state.showSolutionButton && (
                                    <div className="bullet--item2">
                                        <button
                                            class="bullet--solution--button"
                            ...
                            <div className="bullet--info--2">
                                <div className="bullet--item4">
                                    <h1>{color} to Move</h1>
                                </div>
                                <div className="bullet--item1">
                                    <h1>Rating: {rating}</h1>
                                </div>
                                <div className="bullet--item5">
                                    <h1>Score: {score}</h1>
                                </div>

                                <div className="bullet--info--3">
                                    <div className="bullet--item6">
